    ...
    <main class="container-wrapper">
        ...
        <div class="container mt-5">
            ...
            <div class="table-responsive">
                ...
                $sql = "SELECT transaction_tb.*, room_tb.roomtype, room_tb.checkInDate, room_tb.checkOutDate, room_tb.bookedBy,
        ...
        <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editForm">
                            <div class="form-group"  data-transact-id="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="editRoomType" name="roomType" readonly>
                            </div>
                            <div class="form-group">
                                <label for="editPaymentMode">Mode of Payment</label>
                                <input type="text" class="form-control" id="editPaymentMode" name="paymentMode" readonly>
                            </div>
